...
public class ModeloSeparar {
    JLabel label;
     ...
     public ModeloSeparar(JTable table,JTable tabla,DefaultTableModel modelo,ModeloPrincipal principal,JLabel total){
    ...
    public void ponActionListenerCobrar(JButton boton,final JLabel lab,final VistaPrincipal frame,final JTable table,final ModeloPrincipal principal){
    ActionListener actionListener = new ActionListener() {
